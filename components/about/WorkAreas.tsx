...
import { WORK_AREAS } from "@/lib/data/about";
      ...
      <Container className="flex flex-col gap-12">
        <Reveal>
          <SectionHeading
            ...
            description="Occupational Safety & Health remains my strongest professional pillar. The rest extend that same foundation into systems and communication."
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {WORK_AREAS.map((area, index) => {
            ...
            const accent = ACCENT[area.accent];
            return (
              <Reveal key={area.id} delay={index * 100} className="group h-full">
                <div
