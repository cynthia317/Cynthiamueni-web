...
// Pull the verified facts (id, href) for the three featured projects from the
// shared project data so links never drift out of sync with the real Projects
// page. Homepage-only imagery below is chosen independently of that data.
      ...
      >
        ...
        <div className="flex flex-col gap-3 p-4">
          ...
          <div className="flex flex-col gap-1.5 rounded-lg border border-slate-800 p-3">
            <span className="text-[0.6rem] font-semibold uppercase tracking-wide text-slate-400">Risk Overview</span>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-6 sm:p-7">
        ...
        <Link
          href={href}
          className="relative mt-auto inline-flex w-fit items-center gap-1.5 pt-6 text-sm font-semibold text-amber-700 after:absolute after:inset-0 after:content-[''] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-600 dark:text-amber-400"
        >
          View Project
          <ArrowRight
            aria-hidden
...
export default function ProjectsSection() {
  return (
    <section
      ...
      className="relative overflow-hidden bg-white pt-14 pb-20 sm:pt-16 lg:pt-16 dark:bg-slate-950"
    >
      <div
        aria-hidden
      ...
      <Container className="relative flex flex-col">
        <div className="flex flex-col gap-4">
          ...
          <Reveal delay={0} startOpacity={0.2} ariaHidden className="h-px w-full bg-slate-200 dark:bg-slate-800" />
        ...
        <Reveal delay={100} duration={700} distance={16} startOpacity={0.2} className="mt-12">
          <div className="group relative overflow-hidden rounded-[26px] border border-slate-700/70 bg-slate-900 shadow-lg transition-[transform,border-color,box-shadow] duration-500 ease-out motion-reduce:[@media(hover:hover)]:hover:translate-y-0 [@media(hover:hover)]:hover:-translate-y-1 [@media(hover:hover)]:hover:border-cyan-500/40 [@media(hover:hover)]:hover:shadow-xl">
            ...
            />
            <div className="relative grid grid-cols-1 lg:grid-cols-[6fr_7fr] lg:items-center">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
          <Reveal delay={180} duration={700} distance={16} startOpacity={0.2}>
            <SupportingCard
                ...
                <>
                  <Reveal variant="image" duration={700} className="absolute inset-0 z-0">
                    <Image
                      ...
                      alt="Safety professional conducting a workplace inspection and reviewing hazards using a digital checklist"
                      fill
                      sizes="(min-width: 640px) 50vw, 100vw"
                      className="object-cover object-[50%_20%] transition-transform duration-500 ease-out motion-reduce:[@media(hover:hover)]:group-hover:scale-100 [@media(hover:hover)]:group-hover:scale-[1.04]"
                    />
                  </Reveal>
                  <div
                    aria-hidden
                    className="absolute inset-0 z-10 bg-gradient-to-t from-slate-950/60 via-slate-950/5 to-transparent transition-[background] duration-500 [@media(hover:hover)]:group-hover:via-slate-950/20"
                  />
                </>
              }
            />
          ...
          <Reveal delay={260} duration={700} distance={16} startOpacity={0.2}>
            <SupportingCard
              href={SAFETEC.href}
              ...
              visual={
                <>
                  <Reveal variant="image" duration={700} className="absolute inset-0 z-0">
                    <Image
                      src="/images/home/expertise-digital-communication-workspace.webp"
                      alt="Digital workspace used to plan safety content and monitor website and social-media performance"
                      fill
                      sizes="(min-width: 640px) 50vw, 100vw"
                      className="object-cover object-[60%_35%] transition-transform duration-500 ease-out motion-reduce:[@media(hover:hover)]:group-hover:scale-100 [@media(hover:hover)]:group-hover:scale-[1.04]"
                    />
                  </Reveal>
                  <div
                    aria-hidden
